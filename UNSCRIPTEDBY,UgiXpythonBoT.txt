...
local v8 = CreateObject("TextLabel", {
    ...
    Parent = v6,
    BackgroundTransparency = 1,
    Text = "تم صنع هذا السكربت من مطورين تيم TKX",
...
MakeWindow({
Hub = {
Title = "TKX HUB || V0.2 || Brookhaven RB",
Animation = "سكربت TKX HUB"
},
Key = {
KeySystem = false,
Title = "Key System",
...
AddImageLabel(Main, {
  Name = "تم تطوير السكربت بواسطة TKX",
  Image = "rbxassetid://95595481924491"
})
AddSection(Main, {"قائد التيم TRUNKS"})
AddSection(Main, {"نائب القائد TROLLX"})
AddSection(Main, {"المطور JOY"})
AddSection(Main, {"المطور UGIX"})
AddSection(Main, {"المطورة ENJOY"})
AddSection(Main, {"-------------------"})
AddSection(Main, {"روابط التليجرام"})
AddButton(Main, {
  Name = "انسخ رابط قناة التيم في التليجرام",
  Callback = function()
    setclipboard('https://t.me/TKXHUB')
  end
})
AddButton(Main, {
  Name = "انسخ رابط قناة المطور يوجي في التليجرام",
  Callback = function()
    setclipboard('https://t.me/po_ff')
  end
})
AddButton(Main, {
  Name = "انسخ رابط قناة المطورة انجوي-فايروس",
  Callback = function()
    setclipboard('https://t.me/ViRuS_Scrip1')
  end
})
AddButton(Main, {
  Name = "انسخ رابط قناة المطور ترولكس",
  Callback = function()
    setclipboard('https://t.me/TrollXHub1')
  end
})
AddButton(Main, {
  Name = "انسخ رابط قناة المطور جويكس", 
Callback = function()
    setclipboard('https://t.me/kayScript1')
  end
})
AddSection(Main, {"روابط اليوتيوب"})
AddButton(Main, {
  Name = "انسخ يوزر المطور يوجي", 
Callback = function()
    setclipboard('81__i')
  end
})
AddButton(Main, {
  Name = "انسخ يوزر قائد التيم ترانكس", 
Callback = function()
    setclipboard('trunks_1_')
  end
})
AddButton(Main, {
  Name = "انسخ رابط يوزر النائب ترولكس", 
Callback = function()
    setclipboard('trollx.tkx')
  end
})
AddSection(Main, {"روابط اليوتيوب"})
AddButton(Main, {
...
AddButton(Main, {
  Name = "انسخ رابط قناة النائب ترولكس", 
Callback = function()
    setclipboard('https://youtube.com/@troll.x40_40?si=Kos6ATGFSv3kArU-')
  end
})
